...
Welcome 👋 to the architecture knowledge base of pinto-bean.
You will find here all the Architecture Decision Records (ADR) of the project.

## Project Overview

pinto-bean is an infrastructure automation project focused on GitHub repository management via Terraform Cloud. The project emphasizes security-first development practices, comprehensive secret management, and reliable CI/CD pipelines.
